...
def test_query_latest_single_asset(run_cli, tmp_path):
    ...
    populate_ticks(db_path, [
        {"asset": "bitcoin", "price": 41000.0, "timestamp": "2026-01-15T10:00:00Z"},
        {"asset": "bitcoin", "price": 42000.0, "timestamp": "2026-01-15T11:00:00Z"},
        {"asset": "bitcoin", "price": 43000.50, "timestamp": "2026-01-15T12:00:00Z"},
    ])
    ...
    assert "2026" in output or "12:00" in output or "12:" in output, (
        "Output should contain the timestamp of the latest tick"
    )
...
def test_query_latest_default_assets(run_cli, tmp_path):
    ...
    populate_ticks(db_path, [
        ...
        {"asset": "ethereum", "price": 3200.0, "timestamp": "2026-01-15T12:00:00Z"},
    ])
...
def test_query_latest_returns_most_recent(run_cli, tmp_path):
    ...
    populate_ticks(db_path, [
        {"asset": "bitcoin", "price": 43000.0, "timestamp": "2026-01-15T14:00:00Z"},
        {"asset": "bitcoin", "price": 41000.0, "timestamp": "2026-01-15T10:00:00Z"},
        {"asset": "bitcoin", "price": 45000.0, "timestamp": "2026-01-15T16:00:00Z"},
        {"asset": "bitcoin", "price": 42000.0, "timestamp": "2026-01-15T12:00:00Z"},
    ])
    ...
    # The latest tick is 45000.0 at 16:00
